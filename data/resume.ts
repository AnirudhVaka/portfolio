  ...
  sideProjects: [
    {
      ...
      tagline: "AI-grounded exam prep platform for Indian students",
      resumeBlurb:
        "AI-grounded exam prep platform for Indian students. Built end-to-end on Next.js 15 + Supabase + pgvector + Anthropic Claude. Hosted on a $35/month AWS stack with Bubblewrap-wrapped Android TWA. 20+ paying users in beta. Engineering writeup at prepatlas.in/engineering.",
      stack: [
        "Next.js 15",
        "React 19",
        "TypeScript",
    ...
    },
    {
      ...
      resumeBlurb:
        "AI text humanization + resume optimization SaaS. Production-grade auth (NextAuth v5 with email verification, TOTP 2FA backed by AES-256-GCM-encrypted secrets, WebAuthn passkeys), Razorpay payments with discriminated-union typed event handling, Anthropic Claude Sonnet, AWS SES transactional email, Sentry, 31 Jest/Testing-Library tests. Hosted on AWS ECS. 30–40 paying users.",
      stack: [
        "Next.js 16",
        "React 19",
        "TypeScript",
